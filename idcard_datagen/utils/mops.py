...
__all__ = ['base2back_dim_ratio', 'rand_gen', 'random_safe_box_location']


def base2back_dim_ratio(base_img_size: tuple, back_img_size: tuple, ratio: float = 0.5, rtype: str = 'w'):
    hbk, wbk = back_img_size
    hbs, wbs = base_img_size
